        ...
        {userData ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-slate-400 mb-4">Start your communication analysis journey with our AI-powered assessment tool. Get instant feedback on:</p>
            ...
            >
              ...
              <p className="text-slate-400 mb-4">Track your progress and review detailed communication metrics:</p>
              <ul className="text-slate-400 mb-4 list-disc list-inside">
            ...
            >
              ...
              <p className="text-slate-400 mb-4">Your personalized improvement roadmap includes:</p>
              <ul className="text-slate-400 mb-4 list-disc list-inside">
          ...
          <div className="text-center relative">
            ...
            >
              ...
              <p className="text-xl text-slate-400 mb-8">
                Enhance your communication skills with AI-powered analysis and personalized feedback
              </p>
              <motion.button
